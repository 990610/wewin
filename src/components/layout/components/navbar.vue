                    ...
                    <el-row>
                        <el-col :span="24">
                            <el-form-item label="旧密码：" prop="password">
                                <el-input v-model="dialog.form.password" placeholder="请输入旧密码" autocomplete="off" type="password" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="24">
                            <el-form-item label="新密码：" prop="newPassword">
                                <el-input v-model="dialog.form.newPassword" placeholder="请输入新密码" autocomplete="off" type="password" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="24">
                            <el-form-item label="确认密码：" prop="rePassword">
                                <el-input v-model="dialog.form.rePassword" placeholder="请输入新密码" autocomplete="off" type="password" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
...
import { sysUserPassword } from "@/api/system/system-user-api";
