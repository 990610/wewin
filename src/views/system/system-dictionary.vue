    ...
    <div id="system-dictionary">
        ...
        <table-query :handleQuery="handleQuery" :resetQuery="resetQuery">
            <el-form-item label="字典名称：">
                <el-input v-model="queryForm.param" placeholder="请输入字典名称" clearable size="medium" />
            </el-form-item>
        </table-query>
        ...
        <table-box :pagination="pagination" :handleSizeChange="handleSizeChange" :handleCurrentChange="handleCurrentChange">
            <div slot="btn">
                ...
                <el-button v-hasPermi="['sys:dict:down']" type="warning" icon="el-icon-download" size="medium" @click="handleExport">模板导出</el-button>
                <el-upload v-hasPermi="['sys:dict:upload']" class="upload-demo" :action="url" :headers="headers" :file-list="fileList" name="file" :on-success="uploadSuccess">
                    <el-button v-hasPermi="['sys:dict:upload']" type="warning" icon="el-icon-upload2" size="medium">字典上传 </el-button>
                </el-upload>
                <el-button v-hasPermi="['sys:dict:delete']" type="danger" size="medium" v-show="dataListSelections.length > 0" @click="handleDelete()">批量删除</el-button>
            </div>
            <div slot="content">
                <!-- 自定义列 -->
