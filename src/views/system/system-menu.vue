...
<template>
    <div id="system-menu">
        ...
        <table-box :isPaginationShow="false">
            <div slot="btn">
                <el-button v-hasPermi="['sys:menu:save']" type="primary" icon="el-icon-plus" size="medium" @click="handleAdd()">新增</el-button>
            </div>
            <div slot="content">
                <!-- 自定义列 -->
                    ...
                    <el-table-column label="操作" align="center" width="230" fixed="right" v-if="checkPermissions(['sys:menu:update', 'sys:menu:save', 'sys:menu:delete'])">
                        <template slot-scope="scope">
                            <div class="func-btns">
                                ...
                                <el-button v-hasPermi="['sys:menu:save']" size="mini" type="text" icon="el-icon-plus" @click="handleAdd(scope.row)">新增</el-button>
    ...
    data() {
        return {
            ...
            tableLine: [
                ...
                { label: "图标", prop: "icon", width: 70 },
                { label: "权限标识", prop: "perms" },
                { label: "组件", prop: "component" },
                { label: "路径", prop: "path" },
                { label: "排序", prop: "orderNum", width: 70 },
            ],
            tableLineSelect: [],
        };
    },
