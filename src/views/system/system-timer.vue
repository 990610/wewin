...
<template>
    <div id="system-timer">
        ...
        <table-box :pagination="pagination" :handleSizeChange="handleSizeChange" :handleCurrentChange="handleCurrentChange">
            ...
            <div slot="content">
                <!-- 自定义列 -->
                <!-- <table-select :isSelectShow="false" :selectedNum="dataListSelections.length" :table-line="tableLine" @refresh="refreshLine" :clear="clearMul"></table-select> -->
        ...
        <div class="f-dialog log-list">
            <el-dialog v-adaptive="{ type: 'dialog' }" title="日志列表" :visible.sync="dialog.open" custom-class="table-dialog" width="1000px">
                <div class="search">
                    <el-form :inline="true" class="f-query">
                        <el-form-item label="bean名称：">
                            <el-input v-model="dialog.beanName" size="medium" placeholder="操作人姓名" />
                        </el-form-item>
                    ...
                    <div class="table">
                        <el-table v-loading="dialog.loading" :data="dialog.logList" height="400px">
